class Program
{
    static void Main(string[] args)
    {
        ...
        Student student1 = new Student(1, "Alex", "Smith", 2);
        db_Student.AddItem(student1);
        Student student2 = new Student(2, "Thomas", "Brown", 2);
        db_Student.AddItem(student2);
        Student student3 = new Student(3, "Anthony", "Brown", 1);
        db_Student.AddItem(student3);

        DB_Item<Adress> db_Adress = new DB_Item<Adress>();
        Adress adress1 = new Adress(1, "California", 2);
        db_Adress.AddItem(adress1);
        Adress adress2 = new Adress(2, "Texas", 3);
        db_Adress.AddItem(adress2);
        Adress adress3 = new Adress(3, "Mayami", 1);
        db_Adress.AddItem(adress3);

        DB_Item<Subject> db_Subject = new DB_Item<Subject>();
        Subject subject1 = new Subject(1, "Modeling Programming");
        db_Subject.AddItem(subject1);
        Subject subject2 = new Subject(2, "IBM Programming");
        db_Subject.AddItem(subject2);
        Subject subject3 = new Subject(3, "IBM Programming");
